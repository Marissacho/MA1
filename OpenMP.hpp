...
#pragma omp parallel
	...
	std::cout << "Elapsed time of calSum() by OpenMP = " <<
	...
	std::cout << "Elapsed time of calSum() by STL accumulate() = " <<
		std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()
		<< "[milliseconds]" << std::endl;
...
#pragma omp parallel
	...
	// -------------- above TODO: OpenMP implementation --------------
	std::chrono::steady_clock::time_point end = std::chrono::steady_clock::now();
	std::cout << "Elapsed time of calMax() by OpenMP = " <<
		std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()
		<< "[milliseconds]" << std::endl;
	std::vector<int> vect(data, data + data_size);
	begin = std::chrono::steady_clock::now();
	...
	std::cout << "Elapsed time of calMax() by STL max_element() = " <<
		std::chrono::duration_cast<std::chrono::milliseconds>(end - begin).count()
		<< "[milliseconds]" << std::endl;
	assert(max == maxSTL);
